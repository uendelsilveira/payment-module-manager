...
class PayPalGateway implements PaymentGatewayInterface
{
    ...
    {
        throw new NotImplementedException('PayPal get payment status is not implemented.');
    }

    public function refundPayment(string $transactionId, ?float $amount = null): RefundPaymentResponse
    {
        throw new NotImplementedException('PayPal refund payment is not implemented.');
    }

    public function cancelPayment(string $transactionId): CancelPaymentResponse
    {
        throw new NotImplementedException('PayPal cancel payment is not implemented.');
    }
